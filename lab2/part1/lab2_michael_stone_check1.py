        ...
        if first_c and not second_c:
            if col == 0:
                ...
                if (date_pointer == 2 and int(date[4]) < 10) or (date_pointer == 3) or (date_pointer == 4 and int(date[5]) > 9 and int(date[4]) > 9):
                    min = int(date[5]) + 1
                    if min > 9 and ((date_pointer == 2 and int(date[4]) < 10) or (date_pointer == 3 and int(date[4]) > 9)):
                        date_pointer += 1
                    if min > 59:
                        date_pointer -= 1
                        min = 0
                ...
                #     pass
                    ...
                    second = int(date[6]) + 1
                    if second > 9 and ((date_pointer == 4 and int(date[4]) < 10 and int(date[5]) < 10) or (date_pointer == 5 and ((int(date[4]) > 9 and int(date[5]) < 10) )) or (date_pointer == 6 and int(date[4]) > 9 and int(date[5]) > 9)):
                        date_pointer += 1
                    if second > 59:
                        date_pointer -= 1
                        second = 0
